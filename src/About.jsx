import { Building2, Users, Home, BarChart3, FileText, Wrench, CheckCircle, ArrowRight, Menu, Target, Heart, Shield, Globe } from 'lucide-react'
  ...
  const values = [
    {
      ...
      title: 'Local First',
      description: 'From Ejari workflows to PDC tracking and local compliance requirements, our platform is deeply ' +
          'aligned with how property management actually works in the region.'
    },
    {
      image: '/about-icon-2.svg',
      title: 'Efficiency by Design',
      description: 'That’s why we focus on automation, streamlined workflows, and intuitive interfaces that reduce manual ' +
          'effort and eliminate repetitive tasks.'
    },
    {
      image: '/about-icon-3.svg',
      title: 'Customer Success',
      description: 'We are committed to helping you succeed—whether you\'re managing a few properties or scaling a ' +
          'large portfolio. Our platform evolves with your needs.'
    }
  ]
  ...
  const team = [
    {
      ...
      role: 'Founder & CEO',
      description: 'With over 15 years of experience in UAE real estate and technology, Ahmed brings deep industry ' +
          'knowledge and strategic vision to PropManager.'
    },
    {
      image: '/team.svg',
      name: 'Sarah Hassan',
  ...
  const milestones = [
    {
      year: '2020',
      title: 'Founded',
      description: 'PropManager launched in Dubai'
    },
    {
      year: '2021',
      title: '500+ Properties',
      description: 'Reached milestone of 500 managed properties'
    },
    {
      year: '2022',
      title: 'Series A Funding',
      description: 'Secured $5M in funding to expand across UAE'
    },
    {
      year: '2023',
      title: '5000+ Properties',
      description: 'Now managing 5000+ properties across 7 emirates'
    }
  ]
  ...
  return (
    <div className="min-h-screen bg-[#F4F4F4]">
      ...
      <section className="px-6 pt-32 pb-14">
        <div className="bg-white ml-24 mr-24 rounded-2xl p-20 grid md:grid-cols-2 gap-20 items-center">
          <div>
            <h1 className="herosection-h1">
              About PropManager
            </h1>
            <p className="herosection-p">
              PropManager was created to bridge the gap between traditional property management and modern technology.
              We help landlords, investors, and property managers simplify operations, stay compliant, and scale with confidence.
            </p>
      ...
      <section className="px-6 py-10">
        <div className="bg-white ml-24 mr-24 rounded-2xl p-20 items-center">
            <h1 className="herosection-h1">
              From Local Challenges to a Smarter Solution
            </h1>
            <p className="herosection-p4">
              Founded in 2022 in Dubai, PropManager was born out of a clear and recurring problem: property owners and
              managers across the UAE were relying on fragmented tools and manual processes to manage complex operations.
            </p>
            <p className="herosection-p3">
              From tracking post-dated cheques to ensuring Ejari compliance, the existing systems were either
              too generic or not designed for the unique requirements of the UAE market.
            </p>
            <p className="herosection-p3">
              PropManager was designed from the ground up to simplify property management while aligning perfectly with
              local regulations, workflows, and business practices. Every feature—whether it's lease management, payment
              tracking, or maintenance workflows—has been carefully crafted to reduce friction and increase efficiency.
            </p>
        </div>
      </section>

      <section className="py-10 px-6 bg-[#F4F4F4]">
        <div className="bg-white ml-24 mr-24 rounded-2xl p-20 items-center">
          <div className=" grid md:grid-cols-2 gap-20 items-center">
            ...
            <div className="aboutheroimage flex justify-center items-center">
              <p className="herosection-p">
                Our mission is to transform property management in the UAE by providing a platform that simplifies
                compliance, automates operations, and delivers actionable insights.
              </p>
            </div>
          </div>
      ...
      <section className="py-10 px-6 bg-[#F4F4F4]">
        <div className="bg-white ml-24 mr-24 rounded-2xl p-20 items-center">
          ...
          <div>
            <h1 className="herosection-h1">
              Built by Experts in Real Estate & Technology
            </h1>
          </div>
          ...
          <div>
            <div className="grid md:grid-cols-3 gap-8">
              ...
              {team.map((member, index) => (
                  <div key={index} className="p-6 hover:shadow-lg text-justify">
      ...
      <section className="py-10 px-6">
        <div className="cta ml-24 mr-24 rounded-2xl shadow-xl p-20 items-center">
          <h2 className="cta-h2">Start your 14-day free trial</h2>
          <div className="">
            ...
            <div className="w-full md:w-1/2 flex pt-10 gap-4">
              <button className="cta-button1">
                <span style={{color:"#0048FF"}}>Get started free</span>
            ...
            <div className="flex gap-12">
              <div>
                ...
                <ul className="space-y-2">
                  <li><Link to="/features" className="footer-li">Features</Link></li>
