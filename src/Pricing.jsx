import { Building2, Users, Home, BarChart3, FileText, Wrench, CheckCircle, ArrowRight, Menu, ChevronDown, ChevronUp } from 'lucide-react'
...
function Pricing() {
  ...
  const handleMouseEnter = (id) => {
    setHoveredFaq(id)
    // Close any previously clicked FAQ when hovering over a new one
    setOpenFaq(null)
  }
  ...
  const isOpen = (id) => {
    ...
    return hoveredFaq === id || openFaq === id
  }
  ...
  return (
    <div className="min-h-screen bg-[#F4F4F4]">
      ...
      <section className="px-6 pt-32 pb-14">
        <div className="bg-white ml-24 mr-24 rounded-2xl p-20">
        <div className="   items-center feature-hero">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid md:grid-cols-3 gap-8">
              {plans.map((plan) => (
                  <div
                      key={plan.name}
                      className={`bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition relative ${
          ...
          <div className="grid md:grid-cols-2 gap-20 ">
            ...
            <div>
              <p className="herosection-p">
                We offer tailored packages to suit different business needs. Explore our options:
              </p>
            </div>
          </div>
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                answer: 'Yes, you can switch your plan whenever you need. Any adjustments will take effect at the start of your next billing period.'
              },
              {
                id: 'payment-methods',
                question: 'What payment methods do you accept?',
                answer: 'We accept a variety of payment methods to make transactions convenient for you. Options include credit and debit cards, PayPal, and bank transfers. ' +
                    'Feel free to update your payment preferences at any time, and changes will be applied starting from your next billing cycle.'
              },
              {
                id: 'data-security',
                question: 'Is my data secure?',
                answer: 'Absolutely! Your data is protected with top-notch security measures. You can change your plan at any time, ' +
                    'and any updates will be applied at the beginning of your next billing cycle.'
              }
            ].map((faq) => (
              <div
                key={faq.id}
                className="faq-button overflow-hidden"
              ...
              >
                ...
                >
                  <h3 className="faq-h3">{faq.question}</h3>
                  {isOpen(faq.id) ? (
